...
sed -i -e "s#\${PROJECT_REPO}#$projectRepo#" dsl/builder.groovy
sed -i -e "s#\${PIPELINE_REPO}#$pipelineRepoName#" dsl/builder.groovy
sed -i -e "s#\${SONAR_URL}#$sonarUrl#" dsl/builder.groovy
sed -i -e "s#\${SONAR_REPO_NAME}#$projectRepoName#" dsl/builder.groovy
sed -i -e "s/\${PACKAGE_TO_TEST}/$packageToTest/" dsl/builder.groovy
